...
<div class="container-fluid" style="min-height: 300px;">
    ...
    <div class="row mt-3 ml-3 mr-3 ">
            ...
            <div class="card">
                <div class="card-body">
                <?php echo "Welcome back ".($login_type == 3 ? "Dr. ".$login_name.','.$_SESSION['login_name_pref'] : $login_name)."!"  ?>    
                </div>
                <hr>
                ...
                <div class="col-md-3">
                        <div class="card bg-success text-white mb-3">
                            <div class="card-body" style="background-color: #229818">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between bg-custom-green">
                  ...
                  <div class="col-md-3">
                        <div class="card bg-warning text-white mb-3">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        <div class="text-white-75 small">Active Credit</div>
                                        <div class="text-lg font-weight-bold">
                                            <?php 
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="index.php?page=loans">View Credit List</a>
                                <div class="small text-white">
                                    <i class="fas fa-angle-right"></i>
                                </div>
                            </div>
