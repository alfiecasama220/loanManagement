...
<div class="container-fluid main-content">
    ...
    $allowed_pages = array('home', 'loans', 'borrowers', 'plan', 'loan_type', 'users');

    // Check if the requested page is allowed
    if (in_array($page, $allowed_pages)) {
        // If the requested page is 'home', include 'home.php' content here
        if ($page == 'home') {
            // Adjust the file path to include 'home.php' from the root directory
            include '../home.php'; // Assuming 'home.php' is located in the root directory
        } else {
            // For other pages, include the corresponding PHP file
            include $page . '.php';
        }
    } else {
